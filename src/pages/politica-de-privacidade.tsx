...
const CONTACT_EMAIL = 'osspatches@gmail.com';
    ...
    <Layout>
      ...
      <article className="container-site max-w-3xl py-14 md:py-20">
        <header className="border-b border-brand-gray-200 pb-8">
          ...
          <p className="mt-4 leading-relaxed text-brand-gray-600">
            ...
            seus direitos. Tratamos seus dados de acordo com a Lei Geral de Proteção
            de Dados (Lei nº 13.709/2018 — LGPD).
          </p>
        </header>

        <div className="prose-account mt-10 space-y-10">
